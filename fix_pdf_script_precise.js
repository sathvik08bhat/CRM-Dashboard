...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    doc.rect(gL,gstTop,gW+gVW,y-gstTop).strokeColor('#aaaaaa').lineWidth(0.5).stroke();
    doc.moveTo(gVL,gstTop).lineTo(gVL,y).strokeColor('#aaaaaa').lineWidth(0.5).stroke();
    ...
    // Align to the RIGHT, near the amounts
    ...
    console.log("Successfully replaced the PDF Generation block with fixes for Designation, Level, Tel/Email, and Amt In Words alignment!");
} else {
